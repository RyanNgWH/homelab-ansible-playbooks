...
| IT-Tools            | Manage IT-Tools developer tools server        | `ansible-playbook playbooks/it_tools/main.yaml -KJ --tags "<tag>"`            | Supported tags<li>`install`                                          |
...
| Uptime Kuma         | Manage Uptime Kuma monitoring server          | `ansible-playbook playbooks/uptime_kuma/main.yaml -KJ --tags "<tag>"`         | Supported tags<li>`backup`<li>`install`                              |
...
| Your-Spotify        | Manage Your-Spotify statistics server         | `ansible-playbook playbooks/your_spotify/main.yaml -KJ --tags "<tag>""`       | Supported tags<li>`install`                                          |
