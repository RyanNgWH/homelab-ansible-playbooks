...
| Proton Bridge Relay | Manage proton bridge smtp relay               | `ansible-playbook playbooks/proton-bridge-relay/main.yaml -KJ --tags "<tag>"` | Supported tags<li>`install`                                          |
...
| Stirling PDF        | Manage Stirling PDF tools server              | `ansible-playbook playbooks/stirling-pdf/main.yaml -KJ --tags "<tag>"`        | Supported tags<li>`install`<li>`upgrade`                             |
