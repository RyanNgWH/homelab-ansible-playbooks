...
| Bento PDF                        | Manage Bento PDF tools server                 | `ansible-playbook playbooks/bento_pdf/main.yaml -KJ --tags "<tag>"`           | Supported tags<li>`install`<li>`upgrade`                             |
...
| Seerr                            | Manage Seerr media mangement server           | `ansible-playbook playbooks/seerr/main.yaml -KJ --tags "<tag>"`               | Supported tags<li>`install`<li>`upgrade`                             |
| Karakeep                         | Manage Karakeep bookmarking tool server       | `ansible-playbook playbooks/karakeep/main.yaml -KJ --tags "<tag>"`            | Supported tags<li>`install`                                          |
| [Deprecated] Mat2-Web            | Manage Mat2-Web metadata cleaner server       | `ansible-playbook playbooks/mat2_web/main.yaml -KJ --tags "<tag>"`            | Supported tags<li>`install`<li>`upgrade`                             |
...
| Ollama                           | Manage Ollama/Open WebUI server               | `ansible-playbook playbooks/ollama/main.yaml -KJ --tags "<tag>"`              | Supported tags<li>`install`                                          |
...
| [Deprecated] Proton Bridge Relay | Manage proton bridge smtp relay               | `ansible-playbook playbooks/proton_bridge_relay/main.yaml -KJ --tags "<tag>"` | Supported tags<li>`install`                                          |
