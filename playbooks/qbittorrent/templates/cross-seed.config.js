...
module.exports = {
   ...
   */
  torznab: [
    "https://{{ cross_seed_prowlarr_hostname }}/8/api?apikey={{ cross_seed_prowlarr_api_key }}", // HD-Space
    ...
    "https://{{ cross_seed_prowlarr_hostname }}/6/api?apikey={{ cross_seed_prowlarr_api_key }}", // AvistaZ
    "https://{{ cross_seed_prowlarr_hostname }}/7/api?apikey={{ cross_seed_prowlarr_api_key }}", // CinemaZ
  ],
  /**
